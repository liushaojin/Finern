...
namespace SolingScrew.DataDal
{
    ...
    class ModbusTcpDev
    {
        ...
        private string mIP = string.Empty;   //连接IP
        //private static ProExpertDev tcpInstance = null;    //单例模式下实例的声明
        ...
        #region 成员函数区
        //private ProExpertDev()
        //{
        //    //单例的构造函数
        //}
        
        //public static ProExpertDev GetTcpInstance()
        //{
        //    if(tcpInstance == null)
        //    {
        //        tcpInstance = new ProExpertDev();
        //    }
        
        //    return tcpInstance;
        //}
        
        public ModbusTcpDev(string ip)
        {
            mIP = ip;
            ModbusTcpInit();
        }
        private void ModbusTcpInit()
        {
            ConnectModbusTcp();
        }
        ...
        {
            string commIp = mIP;//"192.168.0.1";  //电批1的IP通信地址
            int commPort = 502;
            //创建一个套接字
